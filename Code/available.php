...
<form action="availablecode.php" method="post">
        <div class="container-fluid">
		      ...
		      <div class="row" >
					...
					<div class="row"style="margin:10px;">
					        <div class="col-sm-6 pull-left" style="width:auto; font-size:20px;">No of adults</div><div class="col-sm-6 pull-right"><input type="text" class="form-control" name="k"/></div>
					</div>
					<div class="row"style="margin:10px;">
					        <div class="col-sm-6 pull-left" style="width:auto; font-size:20px;">No of kids</div><div class="col-sm-6 pull-right"><input type="text" class="form-control" name="l"/></div>
					</div>
					<div class="row"style="margin:10px;">
					        <div class="col-sm-6 pull-left" style="width:auto; font-size:20px;">Type of rooms</div><div class="col-sm-6 pull-right"><select class="form-control" name="j">
